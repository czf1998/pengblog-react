export const COMMON_PADDING = 'common-padding '

export const COMMON_BORDER_RADIUS = 'common-border-radius '
...
export const FLEX_ROW_COLUMN_CENTER = 'flex-row-column-center '
