import { GET_SUB_COMMENT_LIST_DATA,
        ...
        BAN_IP_COMMENT_SAGA,
        LIFTED_IP_IPITEM_and_COMMENT_SAGA,
        TRIGGER_IS_LOADING_MORE_SUB_COMMENT } from './actionTypes'
...
export const createTriggerIsLoadingMoreSubComment = (value) => ({
    type: TRIGGER_IS_LOADING_MORE_SUB_COMMENT,
    value
})